define(
	...
	function(
		...
		var createEnvironmentConfig = function( basePath, environmentConfigFilePath ) {
			...
			var configKeys = [ 'androidSdkPath', 'windowsSdkPath', 'spellWindowsPhone8', 'msBuildPath', 'tizenSdkPath', 'jdkPath', 'spellAndroidPath', 'spelliOSPath', 'spellCliPath', 'spellCorePath', 'spellFlashPath' ]
